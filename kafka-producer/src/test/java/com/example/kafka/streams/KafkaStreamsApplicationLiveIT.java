...
@Slf4j
@Testcontainers
@SpringBootTest(classes = ProducerApplication.class, webEnvironment = WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_EACH_TEST_METHOD)
public class KafkaStreamsApplicationLiveIT {
    ...
    @Test
    public void shouldPassTheFlow() throws Exception {
        //when
    ...
    private void createConsumer() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "testGr");
